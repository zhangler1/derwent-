...
import os
import sys
from wos_crawler.parsers.bibtex.wos import bibtex_parser
from wos_crawler.parsers.plaintext.wos import plaintext_parser
...
class WosAdvancedQuerySpiderSpider(scrapy.Spider):
    ...
    start_urls = [r'http://apps.webofknowledge.com/UA_GeneralSearch_input.do?locale=en_US&errorKey=&viewType=input&product=UA&search_mode=GeneralSearch&preferencesSaved=&SID=5FYolirJ1VPLHotbPkE']
    ...
    def parse(self, response):
        ...
        result= ["CDerwent" ,"EDerwent", "MDerwent"]
        # if result is not None:
        #     print('已购买的数据库为：',result)
        #     self.db_list = result

        # 提交post高级搜索请求
        adv_search_url = 'http://apps.webofknowledge.com/DIIDW_AdvancedSearch_input.do?'
    ...
    def parse_results(self, response):
        ...
        totalstart = 0
        # paper_num=30000
        if totalstart+paper_num>100000:
            paper_num=100000-totalstart
            print("大于十万数据取前十万")
        span = 500
        ...
        for i in range(1, iter_num + 1):
            ...
            output_form_derwent = {
                ...
                "search_mode": "AdvancedSearch",
                "locale": "en_US",
                "view_name": "DIIDW-summary",
                "sortBy": "PY.D;LD.D;SO.A;AU.A",
            ...
            yield FormRequest(output_url, method='POST', formdata=output_form_derwent, dont_filter=True,
